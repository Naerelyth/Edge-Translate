...
class AnnotationLayerBuilder {
  ...
  async injectLinkAnnotations(inferredLinks) {
    if (this.#annotations === null) {
      // Rendering was not completed; skip auto-linking instead of throwing.
      console.warn("injectLinkAnnotations skipped: render not finished");
      return;
    }
