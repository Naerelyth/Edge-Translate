...
1. По возможности, мы предоставим пакеты с бета-подписью, которые можно загрузить и установить напрямую. Действия:
    ...
    2. Если вы найдете пакет с примерно таким названием `EdgeTranslate_vx.x.x.x_firefox.xpi` (**4** – номер версии) в параметрах загрузки внизу страницы, тогда просто скачайте и установите его.
