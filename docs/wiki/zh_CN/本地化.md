...
1. Fork 并克隆此[项目](https://github.com/EdgeTranslate/EdgeTranslate)。
...
5. 提交您的更改并将其推送到您 Fork 过来的仓库中；

6. 向我们的仓库创建一个新的[pull request](https://github.com/EdgeTranslate/EdgeTranslate/pulls)。我们将尽快合并您的拉取请求。

### 更多信息

请前往[Chrome 开发者文档](https://developer.chrome.com/extensions/i18n)获取更多信息。
