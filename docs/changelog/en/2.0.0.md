...
-   Added support for **multiple translation providers**, including **Google Translate**, **Bing Translate**, **Baidu Translate** and **Tencent Translate**. More providers are going to be added in the future.

-   Added a hybrid translation provider named **Hybrid Translate**, which can combine results from different providers and provide a better translation. For example, You can use Google Translate to display phonetic symbols and read words aloud, and in the same time use Baidu Translate to obtain word examples;

-   Added **floating mode** for the translation box. Now you can switch the translation displaying mode in floating mode and edge mode by dragging the translation box:
