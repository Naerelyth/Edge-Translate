...
-   更新内置的 PDF 閲讀器至最新版本，**支持 PDF 文件標注**，感謝[pdf.js](https://github.com/mozilla/pdf.js)社區；
-   在内置 PDF 閲讀器中加入複製 PDF 文件鏈接的按鈕，便於快速獲得當前正在閲讀的 PDF 文件的鏈接；
...
-   修復谷歌翻譯退出中國大陸導致 DeepL 翻譯無法使用的問題；
